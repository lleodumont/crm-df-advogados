-- supabase/migrations/20260421000002_ai_agent_seed.sql

INSERT INTO ai_agent_configs (name, system_prompt, modelo, max_turnos, is_active)
VALUES (
  'agente_divorcio_v1',
  $PROMPT$
...
Não repita perguntas que o lead já respondeu espontaneamente.
  ...
  2.1 Situação do casamento
      - Casados ou união estável? Desde quando?
      - Já estão separados de fato? Desde quando?
      - Ainda moram juntos?
